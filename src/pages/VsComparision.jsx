...
const VsComparison = () => {
  ...
  const generatePDF = async () => {
    ...
    try {
      ...
      doc.text('PRODUCT COMPARISON REPORT', 20, 20);
      ...
      // Add products compared
      doc.setFont('helvetica', 'bold');
      doc.text('Products Compared:', 20, 50);
      doc.setFont('helvetica', 'normal');
      doc.text(`• Product 1: ${product1 || 'Image-based product'}`, 20, 60);
      doc.text(`• Product 2: ${product2 || 'Image-based product'}`, 20, 70);
      ...
      for (let i = 1; i <= pageCount; i++) {
        ...
        doc.text('Report generated by AI Product Comparison Tool', 20, 290);
      }
...
---
Report generated by AI Product Comparison Tool
      `.trim();
      ...
      link.href = url;
      link.download = `Product_Comparison_${Date.now()}.txt`;
